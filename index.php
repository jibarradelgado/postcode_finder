...
<div class="container">
    <div class="row">
        <div class="col-md-6 col-md-offset-3 center whitebackground" >
            ...
            <p class="lead center black">Enter any address to find your postcode</p>

            <form>
                <div class="form-group">
                    <input type="text" class="form-control" name="address" id="address" placeholder="Eg. 55 Fake Street, Any City" />
                </div>
            ...
            <div id="fail" class="alert alert-danger">
                Could not find postcode data for that address
            </div>

            <div id="fail2" class="alert alert-danger">
...
<script>
    $("#findMyPostcode").click(function(event) {
        ...
        $.ajax({
            ...
            "&key=AIzaSyDqqliQKNvhBjkyo7LXVCZ2lGT7DRWsbaU",
            dataType:"xml",
            success: processXML,
            error: error
        });
